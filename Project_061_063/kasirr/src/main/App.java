...
public class App {
    ...
    try {
        ...
        LOGGER.info("menggunakan sistem look and feel sebagai fallback");
    } catch (Exception fallbackException) {
        LOGGER.log(Level.WARNING, "gagal memuat sistem look and feel, menggunakan default", fallbackException);
    }
}
